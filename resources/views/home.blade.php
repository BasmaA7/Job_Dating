...
@endif
      ...
      <div class="col-md-4 mb-3">
        <div class="card" style="width: 18rem;">
          <img src="{{ asset('images/job-dating.JPG') }}" class="card-img-top" alt="..." style="height: 150px;"> <!-- Set the desired height here -->
          <div class="card-body">
            <h1 class="card-title">{{ $announcement->name }}</h1>
            <span>Une intro sur E/se :</span>

            <p class="card-text text-center">{{ $announcement->descreption }}</p>
